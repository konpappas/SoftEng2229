import { Options, Plugin as IPlugin } from '@oclif/core/lib/interfaces/plugin';
import { Config as IConfig, ArchTypes, PlatformTypes, LoadOptions } from '@oclif/core/lib/interfaces/config';
import { Hook, Hooks, PJSON, Topic } from '@oclif/core/lib/interfaces';
import * as Plugin from '@oclif/core/lib/config/plugin';
